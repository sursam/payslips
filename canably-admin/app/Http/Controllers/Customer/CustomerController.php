...
class CustomerController extends BaseController
{
    ...
    public function __construct(
        UserService $userService, OrderService $orderService, CountryService $countryService
    ) {
    ...
    {
        $this->setPageTitle('Customer Order Details');
        $id = uuidtoid($request->uuid, 'orders');
        $orderDetails = $this->orderService->getOrdersById($id);
        return view('customer.order.order-details', compact('orderDetails'));
    }
