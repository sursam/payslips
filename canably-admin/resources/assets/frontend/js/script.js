...
$("#grid_btn").on("click",function(){
    ...
    $(".product_grid_view").css("display","flex")
...
$("#list_btn").on("click",function(){
    $(".product_grid_view").css("display","none")
...
(function($) {
  ...
  /*=====================
   ...
   /*=====================
   01. banner slide only imaage
   ==========================*/


   $('.img_single_slide').slick({
    // autoplay: true,
    arrows: true,
    arrows: true,
    dots:true,
    // customPaging : function(img_single_slide, i) {
    //     var thumb = $(img_single_slide.$slides[i]).data();
    //     var index = i + 1
...
/*=======================================
   02. Top Categories Of The Month
========================================*/
...
/*=======================================
   03. Your Trust is Our Top Concern
========================================*/
...
// language  block//
  ...
  $('.category-toggle').on('click', function(e) {
    e.stopPropagation();
      ...
      $('.category-heandle').removeClass("hide-toggle");
      $('.collapse-category').removeClass("hide-toogle");
  ...
  $(document).on('click' , function(e){
    $('.category-heandle').addClass("hide-toggle");
    $('.collapse-category').addClass("hide-toogle");
    $('.category-heandle').toggleClass('open');
    $('.collapse-category').toggleClass('open');
