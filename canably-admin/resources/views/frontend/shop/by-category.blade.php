...
<section class="shop-section">
    <div class="breadcum-box">
        <img src="{{ asset('assets/frontend/images/store-img.jpg') }}" alt="category" class="img-fluid">
        <div class="shop-header-section container">
            <div class="brd-cam">
                <ul>
            ...
            <div class="col-lg-8 col-sm-8 col-12">
                <div class="shop-inner-row">
                            ...
                            <div class="col-lg-6  col-md-6 col-sm-12 col-12">
                                <div class="row upper_right">
                                    <div class="col-lg-7 col-sm-6 col-12">
                                        <div class="show-drp">
                                            <select class="form-select paginate" aria-label="Default select example" name="paginate">
                    ...
                    <div class="product_list_view">
                        @include('frontend.shop.partials.product-horizontal', ['products' => $products])
                    </div>
