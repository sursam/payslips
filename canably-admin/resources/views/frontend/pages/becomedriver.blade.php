...
@section('content')
    <section class="faq_sec">
        ...
        <div class="contact-sec becomdriver_sec">
            <div class="container">
                            ...
                            <div class="registration_form">
                                ...
                                <form action="{{ route('frontend.add.driver') }}" method="post"
                                    ...
                                    <div class="mb-2">
                                        <!-- Start -->
                                        <div>
                                            <label for="document_file" class="block text-sm font-medium mb-1">Driving
                                                Licence
                                                <span class="text-danger">*</span></label>
                                            <input type="file" class="form-control" id="document_file"
                                                name="document_file" accept="image/jpeg,image/png,image/jpg,image/gif">
                                            @error('document_file')
                                                <div class="text-xs mt-1 text-danger">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="address" id="" cols="12" rows="6"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col form-group">
                                            ...
                                            <div class="input-group relative">
                                                <input id="password" class="form-control passwordField" type="password"
                                                    name="password" autocomplete="off">
                                                <div class="input-group-append">
                                                    <button class="btn absolute inset-0 left-auto group passwordHideShow"
