...
@section('content')
    ...
    @include('admin.layouts.partials.page-title', [
        'html' => ['route' => route('admin.delivery.agent.add'), 'text' => 'Add Agent'],
    ])
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap ">
                                    <div class="flex items-center text-center">
                                        ...
                                        <div class="m-1.5">
                                            <!-- Start -->
                                            <a class="btn btn-sm border-slate-200 hover:border-slate-300 text-slate-600"
                                                href="{{ route('admin.delivery.agent.view', $user->uuid) }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-current text-slate-500 shrink-0"
                                                viewBox="0 0 24 22">
                                                    <path
                                        ...
                                        <div class="m-1.5">
                                            <!-- Start -->
                                            <a class="btn btn-sm border-slate-200 hover:border-slate-300 text-slate-600"
                                                href="{{ route('admin.delivery.agent.payouts', $user->uuid) }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-current text-slate-500 shrink-0"
                                                viewBox="0 0 24 22">
                                                    <path
                                                        d="M15 12c0 1.654-1.346 3-3 3s-3-1.346-3-3 1.346-3 3-3 3 1.346 3 3zm9-.449s-4.252 8.449-11.985 8.449c-7.18 0-12.015-8.449-12.015-8.449s4.446-7.551 12.015-7.551c7.694 0 11.985 7.551 11.985 7.551zm-7 .449c0-2.757-2.243-5-5-5s-5 2.243-5 5 2.243 5 5 5 5-2.243 5-5z" />
