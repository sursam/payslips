...
@section('content')
        ...
        <div class="border-t border-slate-200">
            <form method="post" action="{{ route('admin.delivery.agent.edit', $user->uuid) }}" enctype="multipart/form-data">
                ...
                <div class="text-right mt-2">
                    <button type="button" data-bs-toggle="modal" data-bs-target="#viewLicenseModal" class="btn bg-indigo-500 hover:bg-indigo-600 text-white">View licence</button>
                </div>
    ...
    <x-modals.view-licence :user=$user />
@endsection
@push('scripts')
@endpush
