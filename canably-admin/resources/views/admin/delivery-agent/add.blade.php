...
@section('content')
    <div>
        ...
        <div class="border-t border-slate-200">
            <form method="post" action="{{ route('admin.delivery.agent.save') }}" enctype="multipart/form-data">
                @csrf
                            ...
                            <div>
                                ...
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="password">Password<span
                                            class="text-rose-500">*</span></label>
                                    <div class="relative">
                                        <input id="new_password" class="form-input w-full passwordField" type="password"
                    ...
                    <div class="form_field">
                        ...
                        <div class="grid gap-3 md:grid-cols-2">
                            <div>
                                <!-- Start -->
                                <div>
                                    <label for="title" class="block text-sm font-medium mb-1">Id Type <span
                                            class="text-rose-500">*</span></label>
                            ...
                            <div>
                                <!-- Start -->
                                <div>
                                    <label for="document_file" class="block text-sm font-medium mb-1"> Upload Id<span
                                            class="text-rose-500">*</span></label>
                ...
                <div class="space-y-8 mt-8">
                    <div class="form_field">
                        <h2 class="text-xl text-slate-800 font-bold mb-6">Bank Info</h2>
                        <div class="grid gap-4 md:grid-cols-2">
                            <div>
                                <!-- Start -->
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="bfirst_name">First Name <span
                                            class="text-rose-500">*</span></label>
                                    <input id="bfirst_name" class="form-input w-full" type="text" name="bank_details[first_name]"
                                        placeholder="First Name" value="{{ old('first_name') }}" required />
                                    @error('bank_details.first_name')
                                        <div class="text-xs mt-1 text-rose-500">
                                            {{ $message }}
                                        </div>
                                    @enderror
                            ...
                            <div>
                                <!-- Start -->
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="blast_name">Last Name <span
                                            class="text-rose-500">*</span></label>
                                    <input id="blast_name" class="form-input w-full" type="text" name="bank_details[last_name]"
                                        placeholder="Last Name" value="{{ old('last_name') }}" required />
                                    @error('bank_details.last_name')
                                        <div class="text-xs mt-1 text-rose-500">
                                            {{ $message }}
                                        </div>
                                    @enderror
                        ...
                        <div class="grid gap-3 md:grid-cols-2">
                            <div>
                                <!-- Start -->
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="bank">Bank Name<span
                                            class="text-rose-500">*</span></label>
                                    <input id="bank" class="form-input w-full" type="text" name="bank_details[bank]"
                                        value="{{ old('bank_details.bank') }}" required />
                                    @error('bank_details.bank')
                                        <div class="text-xs mt-1 text-rose-500">
                                            {{ $message }}
                                        </div>
                                    @enderror
                            ...
                            <div>
                                <!-- Start -->
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="ach">Ach<span
                                            class="text-rose-500">*</span></label>
                                    <div class="relative">
                                        <input id="ach" class="form-input w-full " type="text" name="bank_details[ach]"
                                            value="{{ old('bank_details.ach') }}" required />
                                    </div>
                                    @error('bank_details.ach')
                                        <div class="text-xs mt-1 text-rose-500">
                                            {{ $message }}
                                        </div>
                                    @enderror
                        ...
                        <div class="grid gap-3 md:grid-cols-2">
                            <div>
                                <label class="block text-sm font-medium mb-1" for="account">Account Number
                                    <span class="text-rose-500">*</span></label>
                                <div class="relative">
                                    <input id="account" class="form-input w-full " type="number" name="bank_details[account]"
                                        value="{{ old('bank_details.account') }}" required />
                                </div>
                                @error('bank_details.account')
                                    <div class="text-xs mt-1 text-rose-500">
                                        {{ $message }}
                                    </div>
                                @enderror
                            ...
                            <div>
                                <label class="block text-sm font-medium mb-1" for="account_confirmation">Confirm
                                    Account
                                    Number
                                    <span class="text-rose-500">*</span></label>
                                <div class="relative">
                                    <input id="account_confirmation" class="form-input w-full " type="text"
                                        name="bank_details[account_confirmation]" value="{{ old('bank_details.account_confirmation') }}" required />
                                </div>
                                @error('bank_details.account_confirmation')
                                    <div class="text-xs mt-1 text-rose-500">
                                        {{ $message }}
                                    </div>
                                @enderror
