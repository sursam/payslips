...
@section('content')
    <div>
        ...
        <div class="border-t border-slate-200">
            <form method="post" action="{{ route('admin.content.edit', $contentData->uuid) }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="grid gap-5 md:grid-cols-3">
                        ...
                        <div>
                            ...
                            <select name="section" class="form-control" id="section">
                                ...
                                <option value="one" @if ($contentData->section == 'one') selected @endif>one</option>
                                <option value="two" @if ($contentData->section == 'two') selected @endif>two</option>
                                <option value="three" @if ($contentData->section == 'three') selected @endif>three</option>
                                <option value="four" @if ($contentData->section == 'four') selected @endif>four</option>
                                <option value="five" @if ($contentData->section == 'five') selected @endif>five</option>
                                <option value="six" @if ($contentData->section == 'six') selected @endif>six</option>
                            </select>
                            @error('section')
                                <div class="text-xs mt-1 text-rose-500">
                                    {{ $message }}
