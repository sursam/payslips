...
@section('content')
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-8">
        ...
        <div class="mb-4 sm:mb-0">
            <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">All Customers</h1>
        </div>
        <!-- Right: Actions -->
        <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
            ...
            <!-- Add customer button -->
            <a class="btn bg-indigo-500 hover:bg-indigo-600 text-white" href="{{ route('admin.customer.add') }}">
    ...
    <div class="bg-white shadow-lg rounded-sm border border-slate-200 mb-8">
        <header class="px-5 py-4">
            <h2 class="font-semibold text-slate-800">All Customers <span
                       ...
                       {{-- {{--  @php
                        ...
                        @forelse ($users as $user)
                            <tr>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="font-medium text-slate-800">{{ $user->fullName?$user->fullName:'---' }}</div>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    ...
                                    <div class="flex items-center text-center">
                                        <div class="m-1.5">
                                            ...
                                            <a class="btn btn-sm border-slate-200 hover:border-slate-300 text-slate-600"
                                                href="{{ route('admin.customer.edit', $user->uuid) }}">
                                        ...
                                        <div class="m-1.5">
                                            <!-- Start -->
                                            <a class="btn btn-sm border-slate-200 hover:border-slate-300 text-slate-600"
                                                href="{{ route('admin.customer.view.address',$user->uuid) }}">
                                                <svg class="w-4 h-4 fill-current text-slate-500 shrink-0 mt-1" viewBox="0 0 20 19" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span class="ml-2">Address Book</span>
                                            </a>
                                            <!-- End -->
                                        </div>
