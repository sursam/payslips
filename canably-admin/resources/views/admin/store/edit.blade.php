                    ...
                    <div class="grid gap-5 md:grid-cols-3">
                        ...
                        <div>
                            ...
                            <select name="is_pickup_ready" id="pickup_ready" class="form-input w-full">
                                <option value="1" {{ $store->is_pickup_ready==1 ?'selected':'' }}>Yes</option>
                                <option value="0" {{ $store->is_pickup_ready==0 ?'selected':'' }}>No</option>
                            </select>
                    ...
                    <div class="grid gap-5 md:grid-cols-3">
                        ...
                        <div>
                            <label class="block text-sm font-medium mb-1" for="zip">Latitude<span
                                    class="text-rose-500">*</span></label>
                            <input id="latitude" class="form-input w-full" type="number" name="latitude" step="0.000001" value="{{ $store->latitude }}"
                        ...
                        <div>
                            ...
                            <input id="longitude" class="form-input w-full" type="number" name="longitude" step="0.000001"
                                placeholder="Longitude" value="{{ $store->longitude }}" />
                            @error('longitude')
                                <div class="text-xs mt-1 text-rose-500">
                                    {{ $message }}
                                </div>
