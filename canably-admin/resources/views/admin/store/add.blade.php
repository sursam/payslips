...
@section('content')
    <div>
        ...
        <div class="border-t border-slate-200">
            <form method="post" action="{{ route('admin.store.save') }}" enctype="multipart/form-data">
                @csrf
                <div class="space-y-8 mt-8">
                    <div class="grid gap-5 md:grid-cols-3">
                        ...
                        <div>
                            <label class="block text-sm font-medium mb-1" for="last_name">Ready for pickup<span
                                    class="text-rose-500">*</span></label>
                            <select name="is_pickup_ready" id="pickup_ready" class="form-input w-full">
                                <option value="1" {{ old('is_pickup_ready')==1 ?'selected':'' }}>Yes</option>
                                <option value="0" {{ old('is_pickup_ready')==0 ?'selected':'' }}>No</option>
                            </select>
                            @error('is_pickup_ready')
                                <div class="text-xs mt-1 text-rose-500">
                                    {{ $message }}
                                </div>
                            @enderror
                    ...
                    <div class="grid gap-5 md:grid-cols-3">
                        ...
                        <div>
                            <label class="block text-sm font-medium mb-1" for="zip">Latitude<span
                                    class="text-rose-500">*</span></label>
                            <input id="latitude" class="form-input w-full" type="number" name="latitude" step="0.000001"
                        ...
                        <div>
                            <label class="block text-sm font-medium mb-1" for="zip">Longitude<span
                                    class="text-rose-500">*</span></label>
                            <input id="longitude" class="form-input w-full" type="number" name="longitude" step="0.000001"
