...
@section('content')
    @php
        $details = $transactionDetail->order->details;
                    ...
                    <div class="form_field">
                        ...
                        <div class="grid gap-3 md:grid-cols-2 ">
                            ...
                            <div class="d-flex">
                                ...
                                <span>${{ $order->details->sum('price') + $order->details->first()->shipping_cost }}</span>
                            </div>
                            <div class="d-flex">
                            ...
                            <div class="d-flex">
                                ...
                                @if ($order->delivery_type == 'delivery')
                                    <span>{{ $order->orderAddress?->shipper_name }}</span>
                                @else
                            ...
                            <div class=" d-flex">
                                ...
                                <div>
                                    <p class="fw-bold">Discount:
                                        <span> ${{ $details->sum('price') - $details->sum('discounted_price') }} </span>
                                    </p>
                                </div>
                                <div>
                                    <p class="fw-bold">Grand Total:
                                        <span>
                                            ${{ number_format($details->sum('price') + $details->sum('shipping_cost'), 2) }}
                                        </span>
                                    </p>
                                </div>
                            ...
                            <div class="grid gap-3 md:grid-cols-3">
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <input id="country" class="form-input w-full" type="text" name="country" placeholder="Country" value="{{ $fullAddress['country'] ?? '' }}" readonly />
                                    </div>
                                    <!-- End -->
                                </div>
                                <div>
