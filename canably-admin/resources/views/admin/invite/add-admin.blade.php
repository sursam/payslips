...
<div>
    ...
    <div class="border-t border-slate-200">
        <form method="post" action="{{ route('admin.invitation.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="space-y-8 mt-8">
                <div class="grid gap-5 md:grid-cols-3">
                    <div>
                        <label for="role_id" class="block text-sm font-medium mb-1">Assign Role <span class="text-rose-500">*</span></label>
                    ...
                    <div>
                        ...
                        <input id="first_name" class="form-input w-full" type="text" name="first_name" placeholder="First Name" value="{{ old('first_name') }}" />
                        @error('first_name')
                        <div class="text-xs mt-1 text-rose-500">
                            {{ $message }}
                        </div>
                    ...
                    <div>
                        ...
                        <input id="last_name" class="form-input w-full" type="text" name="last_name" placeholder="Last Name" value="{{ old('last_name') }}" />
                        @error('last_name')
                        <div class="text-xs mt-1 text-rose-500">
                            {{ $message }}
                        </div>
                    ...
                    <div>
                        ...
                        <input id="email" class="form-input w-full" type="email" name="email" value="{{ old('email') }}" />
                        @error('email')
                        <div class="text-xs mt-1 text-rose-500">
                            {{ $message }}
                        </div>
                    ...
                    <div>
                        ...
                        <input id="phone_no" class="form-input w-full" type="number" name="phone_no" value="{{ old('phone_no') }}" />
                        @error('phone_no')
                        <div class="text-xs mt-1 text-rose-500">
                            {{ $message }}
                        </div>
                    ...
                    <div>
                        ...
                        <input type="file" class="form-control" id="admin_image" name="admin_image" accept="image/jpeg,image/png,image/jpg,image/gif">
                        @error('phone_no')
                        <div class="text-xs mt-1 text-rose-500">
                            {{ $message }}
                        </div>
                ...
                <div class="grid gap-5 md:grid-cols-3">
                    <div>
                        ...
                        <input id="password" class="form-input w-full" type="text" name="password" placeholder="Password" />
                        @error('password')
                        <div class="text-xs mt-1 text-rose-500">
                            {{ $message }}
                        </div>
                    ...
                    <div>
                        <label class="block text-sm font-medium mb-1" for="password">Confirm Password <span class="text-rose-500">*</span></label>
                        <div class="input-group">
                            <input id="confirm_password" class="form-control form-input w-full" type="password" name="confirm_password" placeholder="Confirm Password" />
