...
@section('content')
    @include('admin.layouts.partials.page-title',['html'=>['route'=>route('admin.catalog.brand.add'),'text'=>'Add Brand']])
    <!-- Table -->
    <div class="bg-white shadow-lg rounded-sm border border-slate-200 mb-8">
        <header class="px-5 py-4">
            <h2 class="font-semibold text-slate-800">All Brands <span
                    class="text-slate-400 font-medium">({{ $listBrands->count() }})</span></h2>
        </header>
                    ...
                    <tbody class="text-sm" x-data="{ open: false }">
                        @forelse ($listBrands as $brand)
                            ...
                            <tr>
                                ...
                                <td class="px-1 first:pl-5 last:pr-5 whitespace-nowrap">
                                    <div class="flex items-center text-slate-800">

                                        <img class="ml-2 img-thumbnail banner_image" src="{{ $brand->display_image }}" alt="Icon 01"  />
                                    </div>
                                </td>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    @switch($brand->is_active)
                                        @case(1)
                                            <a href="javascript:void(0)" data-value="0" data-table="brands" data-message="inactive"
                                        ...
                                        @case(0)
                                            <a href="javascript:void(0)" data-value="1" data-uuid="{{ $brand->uuid }}"
                                                data-table="brands" data-message="active"
                                    ...
                                    <div class="flex items-center text-center">
                                        <div class="m-1.5">
                                            ...
                                            <a class="btn btn-sm border-slate-200 hover:border-slate-300 text-slate-600"
                                                href="{{ route('admin.catalog.brand.edit', $brand->uuid) }}">
                                        ...
                                        <div class="m-1.5">
                                            ...
                                            <a class="btn btn-sm border-slate-200 hover:border-slate-300 text-rose-500 deleteData"
                                                data-table="brands" data-uuid="{{ $brand->uuid }}"
        ...
        @include('admin.layouts.paginate', ['paginatedCollection' => $listBrands])
    @endsection
