            ...
            <form action="{{ route('password.update') }}" method="post">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="email" class="form-input w-full" name="email" id="email" value="{{ $email ?? old('email') }}" @error('email') is-invalid @enderror" readonly autocomplete="new-password" autofocus   required />
                    </div>
                    @error('email')
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="password" class="form-input w-full" name="password" id="password" @error('password') is-invalid @enderror"  autocomplete="password" autofocus required />
                    </div>
                    @error('password')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="password" class="form-input w-full" name="password_confirmation" required  @error('password_confirmation') is-invalid @enderror"  autofocus />
                    </div>
                </div>
