...
class SiteNotification extends Notification
{
    ...
    public function via($notifiable)
    {
        ...
        if(
            ...
            $this->data['type'] == 'newRechargeWallet' ||
            $this->data['type'] == 'updateBrandingStatus' ||
    ...
    public function toMail($notifiable)
    {
        ...
        if($this->data['type'] == 'newDriverRegistration'){//queue

            $mailData['line'] = "Welcome to Da'Ride!";
            $mailData['link']           = route('login');
            $mailData['button']         = 'Login';
            $mailData['subject']        = "Welcome to Da'Ride!";
           $mailData['content']           = 'Your registration has been successful.';
        ...
        }else if($this->data['type'] == 'newReview'){//queue
    ...
    public function toDatabase($notifiable)
    {
        ...
        if($this->data['type'] == 'newDriverRegistration' ||
            $this->data['type'] == 'newRechargeWallet' ||
            $this->data['type'] == 'updateBrandingStatus' ||
            $this->data['type'] == 'mediaPurchaseforAdmin' ||
            $this->data['type'] == 'userMembershipPurchaseForAdmin'
