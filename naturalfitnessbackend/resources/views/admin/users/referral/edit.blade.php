    ...
    <div class="container-fluid">
        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            ...
            <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                <form class="user formSubmit fileUpload referral_form" enctype="multipart/form-data" method="post" action="{{ route('admin.referral.user.edit', $referralData->uuid) }}" id="referralsubmit">
                    @csrf
                                ...
                                <div class="input-group">
                                    <select required class="form-control select2bs4 getPopulate reference_source" name="category_id" data-message="Reference Source" id="category_id">
                                        @forelse ($referenceSources as $referenceSource)
                                            <option value="{{ $referenceSource->id }}" @selected($referralData->category_id==$referenceSource->id)>{{ $referenceSource->name }}</option>
                                        @empty
                                        @endforelse
                                    </select>
                                </div>
                                ...
                                <div class="input-group">
                                    <select required class="form-control select2bs4 getPopulate" name="user_id" data-message="Referred User" id="user_id">
                                        ...
                                        @forelse ($users as $user)
                                            <option value="{{ $user->id }}" @selected($referralData->user_id==$user->id)>{{ $user->full_name }}</option>
                                        @empty
                                        @endforelse
                                    </select>
                                </div>
                            ...
                            <div class="col-span-6 lg:col-span-6 2xl:col-span-6 show_for_dsr">
                                ...
                                <div class="input-group">
                                    <select required class="form-control select2bs4 getPopulate reference_type" name="type" data-message="Reference Type" id="reference_type">
                                        ...
                                        <option value="self" @selected($referralData->type=='self')>Self</option>
                                        <option value="other" @selected($referralData->type=='other')>Other</option>
                                    </select>
                                </div>
                                @error('type')
                                    <span class="invalid-feedback d-block" role="alert">
                            ...
                            <div class="col-span-6 lg:col-span-6 2xl:col-span-6 show_for_other show_for_dsr">
                                ...
                                <div class="input-group">
                                    <input type="text" required name="name" class="form-control form-control-user @error('name') is-invalid @enderror"
                                        id="name" placeholder="Referred By" aria-label="Referred By" aria-describedby="basic-addon2" value="{{ $referralData->name }}">
                                </div>
                                @error('name')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col-span-6 lg:col-span-6 2xl:col-span-6 show_for_other show_for_dsr">
                                ...
                                <div class="input-group">
                                    <input type="text" required name="mobile_number" class="form-control form-control-user @error('mobile_number') is-invalid @enderror"
                                        id="name" placeholder="Mobile Number" aria-label="Mobile Number" aria-describedby="basic-addon2" value="{{ $referralData->mobile_number }}">
                                </div>
                                @error('mobile_number')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col-span-6 lg:col-span-6 2xl:col-span-6 show_for_dsr">
                                ...
                                <div class="input-group">
                                    <input type="text" required name="ibd_number" class="form-control form-control-user @error('ibd_number') is-invalid @enderror"
                                        id="name" placeholder="DSR IBD Number" aria-label="DSR IBD Number" aria-describedby="basic-addon2" value="{{ $referralData->ibd_number }}">
                                </div>
                                @error('ibd_number')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
