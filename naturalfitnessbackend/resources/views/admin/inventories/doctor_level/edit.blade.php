    ...
    <div class="container-fluid">
        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            ...
            <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                <form class="user formSubmit fileUpload" enctype="multipart/form-data" method="post" action="{{ route('admin.medical.doctor.level.edit', $categoryData->uuid) }}" id="categorysubmit">
                    @csrf
