                    ...
                    <div class="col-lg-12">
                        <div class="p-3">
                            <form class="user formSubmit fileUpload" enctype="multipart/form-data" method="post"
                                action="{{ route('admin.inventories.brands.add') }}" id="brandsubmit">
                                @csrf
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <input type="text" required name="name" class="form-control form-control-user"
                                            id="name" placeholder="Brand Name" value="{{ old('name') }}">
                                        @error('name')
                                    ...
                                    <div class="col-sm-4">
                                        <input type="url" required name="link" class="form-control form-control-user"
                                            id="link" placeholder="Brand Link" value="{{ old('link') }}">
                                        @error('link')
                                            <span class="d-block text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-sm-4">
                                        <select name="is_popular" id="is_popular" class="form-control "
                                            ...
                                            <option value="0" @selected(old('is_popular') == 1)>No</option>
                                        </select>
                                        @error('is_popular')
                                            <span class="d-block text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="form-group">
                                    <textarea class="form-control form-control-uer col-lg-12" name="description" id="" cols="10"
                                        rows="5" placeholder="Please enter brand description">{{ old('description') }}</textarea>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="custom-file">
                                        <input type="file" name="brand_image"
                                            class="custom-file-input form-control-user showOnUpload"
                                            data-show-loaction="imageBanner" id="brand_image" aria-describedby="brand_image"
                                ...
                                <div class="form-group text-center col-lg-12">
                                    <img class="img-fluid" width="200" height="200" id="showOnUpload"
                                        src="https://static.thenounproject.com/png/3104878-200.png" alt="">
                                </div>
