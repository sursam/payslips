...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 lg:col-span-12 2xl:col-span-12">
            ...
            <form class="user formSubmit fileUpload" enctype="multipart/form-data" method="post" action="{{ route('admin.settings.eligibilities.edit',$categoryData->uuid) }}" id="categorysubmit">
                @csrf
