...
@section('content')
    <div class="intro-y flex items-center mt-8">
        ...
        <div class="col-6 text-right">
            <a href="{{ route('admin.settings.documents.list') }}" class="btn btn-warning btn-icon-split">
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 lg:col-span-12 2xl:col-span-12">
            ...
            <form class="user formSubmit fileUpload" enctype="multipart/form-data" method="post" action="{{ route('admin.settings.documents.edit',$categoryData->uuid) }}" id="categorysubmit">
                @csrf
