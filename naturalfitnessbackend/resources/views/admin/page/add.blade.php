...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 lg:col-span-12 2xl:col-span-12">
            <!-- BEGIN: Add Page Form -->
            <form class="user formSubmit fileUpload" enctype="multipart/form-data" method="post" action="{{ route('admin.cms.page.add') }}" id="pagesubmit">
                @csrf
                <div class="intro-y box lg:mt-5">
                    <div class="p-5">
                        <div>
                            ...
                            <div class="input-group mb-3">
                                <input type="text" required name="name" class="form-control form-control-user @error('name') is-invalid @enderror"
                                    id="name" placeholder="Page Name" aria-label="Page Name" aria-describedby="basic-addon2">
                            </div>
                            @error('name')
                        ...
                        <div>
                            ...
                            <div class="input-group mb-3">
                                <input type="text" required name="title" class="form-control form-control-user @error('title') is-invalid @enderror"
                                    id="title" placeholder="Page Title" aria-label="Page Title" aria-describedby="basic-addon2">
                            </div>
                            @error('title')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <textarea class="form-control form-control-user @error('description') is-invalid @enderror" name="description" id="description" placeholder="Page Content" cols="20" rows="10"></textarea>
                            </div>
                            @error('description')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                ...
                <div class="intro-y box lg:mt-5">
                    <div class="p-5">
                        <div>
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="seo[meta_title]" class="form-control form-control-user" id="name" placeholder="Meta Title">
                            </div>
                        </div>
                        <div>
                            <label for="meta-keyword-form-1" class="form-label">{{ __('Meta Keyword') }} </label></label>
                            <div class="input-group mb-3">
                                <input type="text" name="seo[meta_keywords]" class="form-control form-control-user" id="meta_keyword" placeholder="Meta Keyword">
                            </div>
                        </div>
                        <div>
                            <label for="meta-description-form-1" class="form-label">{{ __('Meta Description') }} </label></label>
                            <div class="input-group mb-3">
                                <textarea class="form-control meta_description" name="seo[meta_description]" id="meta-description" placeholder="Meta Description" cols="10" rows="5"></textarea>
                            </div>
                        </div>                        
                    </div>
                </div>
