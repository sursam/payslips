        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            ...
            <div class="filter-div">
                <div class="export-div">
                    <a href="{{ route('admin.driver.deleted.export', ['driver']) }}" class="btn btn-sm btn-primary">Export</a>
                </div>
                <table class="table table-report -mt-2 customdatatable" id="deletedDriverTable" data-vtype="{{ !$type ? 'auto' : $type }}" data-action="full">
                    <thead>
