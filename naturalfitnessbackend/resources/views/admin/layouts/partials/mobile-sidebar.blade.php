...
<div class="mobile-menu md:hidden">
    ...
    <div class="scrollable">
        ...
        <ul class="scrollable__content py-2">
            <li>
                <a href="javascript:;.html" class="menu menu--active">
                    ...
                    <div class="menu__title"> Dashboard <i data-lucide="chevron-down"
                            class="menu__sub-icon transform rotate-180"></i>
                    </div>
                </a>
                <ul class="menu__sub-open">
                    <li>
                        <a href="side-menu-dark-dashboard-overview-1.html" class="menu menu--active">
                            ...
                            <div class="menu__title"> Overview
                                1 </div>
                        </a>
                    </li>
                    <li>
            ...
            <li>
                <a href="javascript:;" class="menu">
                    <div class="menu__icon"> <i data-lucide="shopping-bag"></i>
                    </div>
                ...
                <ul class>
                    ...
                    <li>
                        <a href="javascript:;" class="menu">
                            ...
                            <div class="menu__title">
                                Transactions <i data-lucide="chevron-down" class="menu__sub-icon "></i>
                            </div>
                        </a>
                        <ul class>
                            <li>
                                <a href="side-menu-dark-transaction-list.html" class="menu">
                                    ...
                                    <div class="menu__title">Transaction
                                        List</div>
                                </a>
                            </li>
                            <li>
            ...
            <li>
                <a href="side-menu-dark-file-manager.html" class="menu">
                    <div class="menu__icon"> <i data-lucide="hard-drive"></i>
                    </div>
                    <div class="menu__title"> File Manager
                    </div>
                </a>
            </li>
            <li>
                <a href="side-menu-dark-point-of-sale.html" class="menu">
                    <div class="menu__icon"> <i data-lucide="credit-card"></i>
                    </div>
                    <div class="menu__title"> Point of Sale
                    </div>
                </a>
            </li>
            <li>
                <a href="side-menu-dark-chat.html" class="menu">
                    <div class="menu__icon"> <i data-lucide="message-square"></i>
                    </div>
            ...
            <li>
                <a href="side-menu-dark-post.html" class="menu">
                    <div class="menu__icon"> <i data-lucide="file-text"></i>
                    </div>
                ...
                <ul class>
                    <li>
                        <a href="side-menu-dark-users-layout-1.html" class="menu">
                            ...
                            <div class="menu__title"> Layout 1
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="side-menu-dark-users-layout-2.html" class="menu">
                            ...
                            <div class="menu__title"> Layout 2
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="side-menu-dark-users-layout-3.html" class="menu">
                            ...
                            <div class="menu__title"> Layout 3
                            </div>
                        </a>
                    </li>
                </ul>
                ...
                <ul class>
                    ...
                    <li>
                        <a href="login-dark-register.html" class="menu">
                            ...
                            <div class="menu__title"> Register
                            </div>
                        </a>
                    </li>
                    <li>
                ...
                <ul class>
                    ...
                    <li>
                        <a href="side-menu-dark-progress-bar.html" class="menu">
                            ...
                            <div class="menu__title"> Progress
                                Bar </div>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="side-menu-dark-dropdown.html" class="menu">
                            ...
                            <div class="menu__title"> Dropdown
                            </div>
                        </a>
                    </li>
                    <li>
                ...
                <ul class>
                    ...
                    <li>
                        <a href="javascript:;" class="menu">
                            ...
                            <div class="menu__title"> Wysiwyg
                                Editor <i data-lucide="chevron-down" class="menu__sub-icon "></i>
                            </div>
                        </a>
                        <ul class>
                            <li>
