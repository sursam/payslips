    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 lg:col-span-12 2xl:col-span-12">
            ...
            <form class="user formSubmit fileUpload" enctype="multipart/form-data" method="post"
                id="supportsubmit" action="{{ route('admin.support.type.edit', $supportData->uuid) }}">
                @csrf
                <div class="intro-y box lg:mt-5">
                    <div class="p-5">
                        <div>
                            <label for="title-form-1" class="form-label">{{ __('Support Type') }} <span
                            ...
                            <div class="input-group mb-3">
                                <input type="text" required name="name"
                                    ...
                                    id="question" placeholder="Support Type" aria-label="Start Time"
                                    aria-describedby="basic-addon2" value="{{ $supportData->name }}">
                            </div>
                            @error('title')
