    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 lg:col-span-12 2xl:col-span-12">
            ...
            <form class="user formSubmit fileUpload" enctype="multipart/form-data" method="post"
                action="{{ route('admin.settings.membership.edit',$plan->uuid) }}" id="pagesubmit">
                @csrf
                    ...
                    <div class="p-5 grid grid-cols-12 gap-6">
                        <div class="col-span-12 lg:col-span-12 2xl:col-span-12">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" required name="name" value="{{ $plan->name ?? old('name') }}"
                        ...
                        <div class="col-span-6 lg:col-span-6 2xl:col-span-6">
                            <label for="name-form-1" class="form-label">{{ __('Duration(Days)') }} <span
                                    class="text-danger"><sup>*</sup></span></label></label>
                            <div class="input-group mb-3">
                                <input type="number" required name="duration" value="{{ $plan->price->duration ??  old('duration') }}"
                        ...
                        <div class="col-span-6 lg:col-span-6 2xl:col-span-6">
                            <label for="name-form-1" class="form-label">{{ __('Amount($)') }} <span
                                    class="text-danger"><sup>*</sup></span></label></label>
                            <div class="input-group mb-3">
                                <input type="number" required name="price" value="{{ $plan->price->price ?? old('price') }}"
                                    class="form-control form-control-user @error('price') is-invalid @enderror" id="price" placeholder="Amount" aria-label="Amount" aria-describedby="basic-addon2">
                            </div>
                            @error('price')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
