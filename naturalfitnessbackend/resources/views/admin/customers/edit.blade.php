...
@section('content')
    <div class="intro-y items-center mt-8 grid grid-cols-12 gap-6">
        <div class="col-span-6">
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                    <h2 class="text-lg font-medium mr-auto">
                        <a href="{{ route('admin.users.customer.company',$userData->uuid) }}" class="nav-link">
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 lg:col-span-12 2xl:col-span-12">
            <!-- BEGIN: Add User Form -->
            <form class="user formSubmit fileUpload" enctype="multipart/form-data" method="post" action="{{ route('admin.users.customer.edit',$userData->uuid) }}" id="usersubmit">
                @csrf
                <div class="intro-y box lg:mt-5">
                    <div class="p-5 grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-6 lg:col-span-6 2xl:col-span-6">
                            ...
                            <div class="input-group">
                                <input type="text" required name="mobile_number" class="form-control form-control-user @error('mobile_number') is-invalid @enderror" id="name" placeholder="Mobile Number" aria-label="Mobile Number" aria-describedby="basic-addon2" value="{{ $userData->mobile_number }}">
                            </div>
                            @error('mobile_number')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
