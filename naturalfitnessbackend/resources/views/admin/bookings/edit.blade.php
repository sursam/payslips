...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 lg:col-span-12 2xl:col-span-12">
            <!-- BEGIN: Add User Form -->
            <form class="user formSubmit fileUpload" enctype="multipart/form-data" method="post" action="{{ route('admin.booking.edit', $bookingData->uuid) }}" id="usersubmit">
                @csrf
                            ...
                            <div class="input-group">
                                ...
                                data-location="issues" data-message="issue" id="issue_id">
                                    ...
                                    @forelse ($issues as $issue)
                                        <option value="{{ $issue->id }}" @selected($bookingData->issue_id == $issue->id)>
                                            {{ $issue->name }}
                                        </option>
                                    @empty
                                    @endforelse
                            ...
                            <div class="input-group">
                                ...
                                data-location="doctors" data-message="doctor" id="doctor_id">
                                    ...
                                    @forelse ($doctors as $doctor)
                                        <option value="{{ $doctor->id }}" @selected($bookingData->doctor_id == $doctor->id)>
                                            {{ $doctor->full_name }}
                                        </option>
                                    @empty
                                    @endforelse
                            ...
                            <div class="input-group">
                                ...
                                data-location="patients" data-message="patient" id="patient_id">
                                    ...
                                    @forelse ($patients as $patient)
                                        <option value="{{ $patient->id }}" @selected($bookingData->patient_id == $patient->id)>
                                            {{ $patient->full_name }}
                                        </option>
                                    @empty
                                    @endforelse
                ...
                <div class="intro-y box lg:mt-5">
                    <div class="p-5 grid grid-cols-12 gap-6">
                        <div class="col-span-6 lg:col-span-6 2xl:col-span-6">
                            ...
                            <div class="input-group">
                                <select class="form-control select2 @error('booking_for') is-invalid @enderror" name="booking_for" data-message="Booking For" id="booking_for">
                                    ...
                                    <option value="self" @selected($bookingData->details->booking_for == 'self')>Self</option>
                                    <option value="other" @selected($bookingData->details->booking_for == 'other')>Other</option>
                                </select>
                            </div>
                            @error('booking_for')
                                <span class="invalid-feedback d-block" role="alert">
                        ...
                        <div class="col-span-6 lg:col-span-6 2xl:col-span-6">
                            ...
                            <div class="input-group">
                                <input type="text" name="other_name" class="form-control form-control-user @error('other_name') is-invalid @enderror" id="other_name" placeholder="Name" aria-label="Name" aria-describedby="basic-addon2" value="{{ $bookingData->details->partner_info['name'] }}">
                            </div>
                            @error('other_name')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-span-6 lg:col-span-6 2xl:col-span-6">
                            ...
                            <div class="input-group">
                                <input type="number" name="other_age" class="form-control form-control-user @error('other_age') is-invalid @enderror" id="other_age" placeholder="Age" aria-label="Age" aria-describedby="basic-addon2" value="{{ $bookingData->details->partner_info['age'] }}">
                            </div>
                            @error('other_age')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-span-6 lg:col-span-6 2xl:col-span-6 booking_for_other">
                            ...
                            <div class="input-group">
                                <input type="text" name="other_relationship" class="form-control form-control-user @error('other_relationship') is-invalid @enderror" id="other_relationship" placeholder="Ex. Mother, Father" aria-label="Relationship With Patient" aria-describedby="basic-addon2" value="{{ $bookingData->details->partner_info['relationship'] }}">
                            </div>
                        ...
                        <div class="col-span-6 lg:col-span-6 2xl:col-span-6 booking_for_other">
                            ...
                            <div class="input-group">
                                <select class="form-control select2 @error('other_gender') is-invalid @enderror" name="other_gender" data-message="gender" id="other_gender">
                                    <option value="">Select Gender</option>
                                    <option value="male" @selected($bookingData->details->partner_info['gender'] == 'male')>Male</option>
                                    <option value="female" @selected($bookingData->details->partner_info['gender'] == 'female')>Female</option>
                                    <option value="other" @selected($bookingData->details->partner_info['gender'] == 'other')>Other</option>
                                </select>
                            </div>
                            @error('other_gender')
                                <span class="invalid-feedback d-block" role="alert">
                        ...
                        <div class="col-span-6 lg:col-span-6 2xl:col-span-6">
                            ...
                            <div class="input-group">
                                <select class="form-control select2 @error('consultaion_type') is-invalid @enderror" name="consultaion_type" data-message="Type of Consultation" id="consultaion_type">
                                    <option value="">Select</option>
                                    <option value="online" @selected($bookingData->details->consultaion_type == 'online')>Online</option>
                                    <option value="offline" @selected($bookingData->details->consultaion_type == 'offline')>Offline</option>
                                </select>
                            </div>
                            ...
                            <div class="input-group">
                                <select class="form-control select2 @error('doctor_level_id') is-invalid @enderror" name="doctor_level_id" data-message="Who you want" id="doctor_level_id">
                                    ...
                                    @forelse ($doctorLevels as $doctorLevel)
                                        <option value="{{ $doctorLevel->id }}" @selected($bookingData->details->doctor_level_id == $doctorLevel->id)>
                                            {{ $doctorLevel->name }}
                                        </option>
                                    @empty
                                    @endforelse
                        ...
                        <div class="col-span-12 lg:col-span-12 2xl:col-span-12">
                            ...
                            <div class="input-group">
                                <textarea name="other_info" class="form-control form-control-user @error('other_info') is-invalid @enderror" id="other_info" placeholder="Other info" aria-label="Other info" aria-describedby="basic-addon2">{{ $bookingData->details->other_info }}</textarea>
                            </div>
                ...
                <div class="intro-y box lg:mt-5">
                    <div class="p-5 grid grid-cols-7 gap-6 date_row">
                        @for($i = 1; $i <= 7; $i++)
                            <div class="date_box">
                                <input type="radio" id="date{{ $i }}" name="booking_date" value="{{ \Carbon\Carbon::today()->addDays($i)->format('Y-m-d') }}" class="booking_date" @checked(\Carbon\Carbon::parse($bookingData->booking_datetime)->format('Y-m-d') == \Carbon\Carbon::today()->addDays($i)->format('Y-m-d')) data-bookedtime="{{ (\Carbon\Carbon::parse($bookingData->booking_datetime)->format('Y-m-d') == \Carbon\Carbon::today()->addDays($i)->format('Y-m-d')) ? $bookingData->booking_datetime : '' }}">
                                <label for="date{{ $i }}">
