...
@section('content')
    <div class="intro-y flex items-center mt-8">
        ...
        <div class="col-6 text-right">
            <a href="{{ route('admin.grant.settings.form.add') }}" class="btn btn-primary btn-icon-split">
                <span class="icon text-white-50">
                    <i class="fas fa-plus"></i>
                </span>
                <span class="text">{{ __('Add New Field') }}</span>
            </a>
        </div>
    </div>
                                ...
                                <td>
                                    <div class="flex justify-center items-center">
                                        <a class="flex items-center mr-3"
                                            href="{{ url('admin/grant/settings/form/edit', [$value['uuid']]) }}"><span
                                                class="icon text-white-50"><i class="fas fa-edit"></i></span><span
                                                class="text">Edit</span></a>
                                        {{-- <a href="http://127.0.0.1:8000/terms-condition" class="flex items-center mr-3"><span class="icon text-white-50"><i class="fas fa-eye"></i></span><span class="text">View</span></a> --}}
                                        <a class="flex items-center text-danger deleteTableData" href="javascript:void(0);"
                                            data-table="application_forms" data-uuid="{{ $value['uuid'] }}"><span
