    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 lg:col-span-12 2xl:col-span-12">
            ...
            <form class="user formSubmit fileUpload" enctype="multipart/form-data" method="post"
                action="{{ route('admin.medical.issue.edit', $issueData->uuid) }}" id="issuesubmit">
                @csrf
                <div class="intro-y box lg:mt-5 grid grid-cols-12 gap-6">
                        ...
                        <div class="pb-5">
                            ...
                            <div class="input-group">
                                <input type="text" required name="name"
                                    ...
                                    aria-describedby="basic-addon2" value="{{ $issueData->name }}">
                            </div>
                            @error('name')
                        ...
                        <div class="pt-5 pb-5">
                            ...
                            <div class="input-group">
                                <select name="type" id="type" class="form-control form-control-user">
                                    ...
                                    <option value="self" @selected($issueData->type == 'self')>Self</option>
                                    <option value="both" @selected($issueData->type == 'both')>Both</option>
                                </select>
                            </div>
                            @error('type')
                                <span class="invalid-feedback d-block" role="alert">
                        ...
                        <div class="pt-5 pb-5">
                            ...
                            <div class="input-group">
                                <select name="gender" id="gender" class="form-control form-control-user">
                                    ...
                                    <option value="male" @selected($issueData->gender == 'male')>Male</option>
                                    <option value="female" @selected($issueData->gender == 'female')>Female</option>
                                </select>
                            </div>
                            @error('gender')
                                <span class="invalid-feedback d-block" role="alert">
                    ...
                    <div class="col-span-6 lg:col-span-6 2xl:col-span-6 p-5">
                        ...
                        <div class="col-sm-12">
                            <textarea class="form-control form-control-user @error('description') is-invalid @enderror" name="description" id="description" placeholder="Description" cols="20" rows="10">{{ $issueData->description }}</textarea>
                        </div>
                        @error('description')
                            <span class="invalid-feedback d-block" role="alert">
                                <strong>{{ $message }}</strong>
