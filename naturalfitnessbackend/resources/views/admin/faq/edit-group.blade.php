...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 lg:col-span-12 2xl:col-span-12">
            <!-- BEGIN: Edit FAQ Group Form -->
            <form class="user formSubmit fileUpload" enctype="multipart/form-data" method="post"
                action="{{ route('admin.support.faq.group-edit', $faqGroupData->uuid) }}" id="faqsubmit">
                @csrf
                        ...
                        <div>
                            ...
                            <div class="input-group mb-3">
                                <input type="text" required name="name"
                                    ...
                                    aria-describedby="basic-addon2" value="{{ $faqGroupData->name }}">
