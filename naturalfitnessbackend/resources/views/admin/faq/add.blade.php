    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 lg:col-span-12 2xl:col-span-12">
            ...
            <form class="user formSubmit fileUpload" enctype="multipart/form-data" method="post"
                action="{{ route('admin.support.faq.add') }}" id="faqsubmit">
                @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                {{--  <input type="text" required name="answer"
                                    ...
                                    id="FAQ Answer" placeholder="FAQ Answer" aria-label="FAQ Answer"
                                    aria-describedby="basic-addon2">  --}}
                                    <textarea required name="answer"
                                    class="form-control timepicker form-control-user @error('answer') is-invalid @enderror"
                                    id="answer" cols="10" rows="3"></textarea>
                            </div>
                            @error('answer')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
