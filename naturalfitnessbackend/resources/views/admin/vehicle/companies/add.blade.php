...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 lg:col-span-12 2xl:col-span-12">
            <!-- BEGIN: Add Vehicle Company Form -->
            <form class="user formSubmit fileUpload" enctype="multipart/form-data" method="post" action="{{ route('admin.vehicle.company.add') }}" id="vehiclesubmit">
                @csrf
                        ...
                        <div class="col-span-12 lg:col-span-12 2xl:col-span-12">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" required name="name" class="form-control form-control-user @error('name') is-invalid @enderror"
                                    id="name" placeholder="Company Name" aria-label="Company Name" aria-describedby="basic-addon2">
                            </div>
                            @error('name')
