...
@section('content')
    <div class="intro-y flex items-center mt-8">
        ...
        <div class="col-6 text-right">
            <a href="{{ $vehicleTypeData->parent ? route('admin.vehicle.type.list', $vehicleTypeData->parent->uuid) : route('admin.vehicle.type.list') }}" class="btn btn-warning btn-icon-split">
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 lg:col-span-12 2xl:col-span-12">
            <!-- BEGIN: Edit Vehicle Type Form -->
            <form class="user formSubmit fileUpload" enctype="multipart/form-data" method="post" action="{{ route('admin.vehicle.type.edit',$vehicleTypeData->uuid) }}" id="vehiclesubmit">
                @csrf
                        ...
                        <div class="col-span-12 lg:col-span-12 2xl:col-span-12">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" required name="name" class="form-control form-control-user @error('name') is-invalid @enderror"
                                    id="name" placeholder="Vehicle Type" aria-label="Vehicle Type" aria-describedby="basic-addon2" value="{{ $vehicleTypeData->name }}">
                            </div>
                            @error('name')
