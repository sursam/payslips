...
@section('content')
    <div class="intro-y flex items-center mt-8">
        ...
        {{-- <div class="col-6 text-right">
            <a href="{{ route('admin.vehicle.type.add') }}" class="btn btn-primary btn-icon-split">
                <span class="icon text-white-50 mr-1">
                    <i class="fas fa-plus"></i>
                </span>
                <span class="text">{{ __('Add New Vehicle Type') }}</span>
            </a>
        </div>    --}}
    </div>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2 customdatatable" id="vehicleTypesTable" data-uuid="{{ $uuid }}">
                <thead>
