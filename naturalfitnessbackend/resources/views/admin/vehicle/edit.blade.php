...
@section('content')
    <div class="intro-y flex items-center mt-8">
        ...
        <div class="col-6 text-right">
            <a href="{{ route('admin.vehicle.list') }}" class="btn btn-warning btn-icon-split">
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 lg:col-span-12 2xl:col-span-12">
            ...
            <form class="user formSubmit fileUpload" enctype="multipart/form-data" method="post" action="{{ route('admin.vehicle.edit',$vehicleData->uuid) }}" id="vehiclesubmit">
                @csrf
                <div class="intro-y box lg:mt-5">
                    <div class="p-5 grid grid-cols-12 gap-6">
                        <div class="col-span-6 lg:col-span-6 2xl:col-span-6">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" required name="registration_number" class="form-control form-control-user @error('registration_number') is-invalid @enderror"
                                    id="registration_number" placeholder="Vehicle Number" aria-label="Vehicle Number" aria-describedby="basic-addon2" value="{{ $vehicleData->registration_number }}">
                            </div>
                            @error('name')
                        ...
                        <div class="col-span-6 lg:col-span-6 2xl:col-span-6">
                            <label for="type_id-form-1" class="form-label">{{ __('Vehicle Type') }} <span class="text-danger"><sup>*</sup></span></label></label>
                            <div class="input-group mb-3">
                        ...
                        <div class="col-span-6 lg:col-span-6 2xl:col-span-6">
                            <label for="company_id-form-1" class="form-label">{{ __('Vehicle Company') }} <span class="text-danger"><sup>*</sup></span></label></label>
                            <div class="input-group mb-3">
